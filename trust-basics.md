...
4. Verify that `alpine:latest` is the only image on your host

  ```
  $ docker image ls
  REPO    TAG          IMAGE ID            CREATED             SIZE
  alpine  latest       7328f6f8b418        3 months ago        3.97MB
  ```
...
To complete this step you will need a Docker ID. If you don't have one, you can sign up for one for free at hub.docker.com or cloud.docker.com.
